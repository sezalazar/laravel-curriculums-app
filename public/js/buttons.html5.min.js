...
if(f){c.buttons.info(c.i18n("buttons.copyTitle","Copiar al portapapeles"),c.i18n("buttons.copySuccess",{1:"Copiada one row to clipboard",_:"Copiado %d rows al portapapeles"},a.rows),2E3);return}}catch(h){}}f=i("<span>"+c.i18n("buttons.copyKeys","Presiona <i>ctrl</i> o <i>⌘</i> + <i>C</i> para copiar los datos de la tabla<br>to your system clipboard.<br><br>To cancel, click this message or press escape.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copiar al portapapeles"),f,0);b[0].focus();b[0].select();
