...
<p style="margin-top: 10px"></p>
  <div style="border: 1px solid gray">
    <div class="form-group row spacingForm required">
        <p style="margin-top: 5px"></p>
        <label for="inputIdentity" class="col-sm-2 col-form-label control-label">Nro Documento</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="dni" id="inputIdentity" placeholder="Ingrese su número de identidad" @if (isset($cv->dni)) value="{{ $cv->dni }}" @else value="{{old('dni')}}"  @endif/>
        </div>
    </div>
    <div class="form-group row spacingForm required">
        <label for="inputName" class="col-sm-2 col-form-label control-label">Nombre y Apellido</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputName" name="nombre" placeholder="Ingrese su nombre completo" @if (isset($cv->name)) value="{{ $cv->name }}" @else value="{{old('nombre')}}" @endif />
        </div>
    </div>
    <div class="form-group row spacingForm required">
        <label for="inputEmail" class="col-sm-2 col-form-label control-label">Email</label>
            <div class="col-sm-10">
                <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Ingrese su email" @if (isset($cv->email)) value="{{ $cv->email }}" @else value="{{old('email')}}"  @endif  required/>
            </div>
    </div>
    <div class="form-group row spacingForm required">
        <label for="inputStreet" class="col-sm-2 col-form-label control-label">Calle</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Nombre de su calle" name="calle" @if (isset($cv->street)) value="{{ $cv->street }}" @else value="{{old('calle')}}" @endif>
        </div>
    </div>
    <div class="form-group row spacingForm required">
        <label for="inputStreet" class="col-sm-2 col-form-label control-label">Número de Calle</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" placeholder="Número de su calle" name="númeroCalle" @if (isset($cv->streetNbr)) value="{{ $cv->streetNbr }}" @else value="{{old('númeroCalle')}}" @endif >
        </div>
    </div>
    <div class="form-group row g-3 spacingForm required">
        <div class="col-md-6 position-relative">
            <label for="country" class="form-label control-label">Provincia</label>
            @php $selected = '';  @endphp
            <select name="provincia" class="form-select"  id="provincia" required>
                ...
                <option value="{{ $provincia->nombre }}"
                    @if (isset($cv))
                    {
                        {{ $provincia->nombre == $cv->provincia ? $selected = 'selected' : '' }}
                    }
                    {{-- TODO: else Provincia by default: <option value="">Provincia</option> --}}
                    @endif
        ...
        <div class="col-md-3 position-relative">
            <label for="state" class="form-label control-label">Ciudad</label>
            @php $selectedCity = '';  @endphp
            {{-- TODO: Try if I can send the array of municipios to let the user change only the city on edit
            (and not having to change provincia and then select the same provincia again) --}}
        ...
        <div class="col-md-3 position-relative">
            ...
            <input type="text" name="códigoPostal" class="form-control" id="validationCustom05" placeholder="Código Postal" @if (isset($cv->cp)) value="{{ $cv->cp }}"   @endif required/>
        ...
        @if (isset($phones))
            ...
            @foreach($phones as $key => $phone)
                        ...
                        <div class="form-group row spacingForm required" >
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="phone[]" placeholder="Ingrese su teléfono" class="form-control" @if(old('phone')) value="{{old('phone.0')}}" else value="{{ $phone->phone }}" @endif />
                            </div>
                                <div class="col-sm-2">
    ...
    <label for="inputBirthDate" class="col-sm-2 col-form-label control-label">Fecha de nacimiento</label>
        <div class="col-sm-10">
            <input type="date" class="form-control" id="inputBirthDate" name="fechaDeNacimiento" placeholder="Ingrese su fecha de nacimiento" @if (isset($cv->dateOfBirth)) value="{{ $cv->dateOfBirth }}" @endif />
        </div>
    </div>
    <div class="form-group row spacingForm " >
